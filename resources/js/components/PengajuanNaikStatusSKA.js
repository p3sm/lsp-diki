...
export default class Personal extends Component {
    ...
    getKualifikasi(){
      ...
      axios.post(`/api/kualifikasi_ta_99`, body).then(response => {
        let result = response.data
        console.log(result.data)
              ...
              {this.state.biodata != null && (
                <Tabs defaultActiveKey="biodata" id="">
                  ...
                  <Tab eventKey="kualifikasi" title="Klasifikasi Kualifikasi">
                    <ViewKualifikasi tipe_profesi={1} id_personal={this.state.id_personal} data={this.state.kualifikasi_ta} refreshData={() => this.getKualifikasi()}/>
                  </Tab>
                </Tabs>
              )}
            </Form>
...
if (document.getElementById('pengajuan_ska')) {
    ReactDOM.render(<Personal />, document.getElementById('pengajuan_ska'));
}
